        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <br>
                        <a href="<?php echo base_url('Home/biodata'); ?>" class="btn btn-danger btn-sm" role="button">Tambah Keluarga</a> <a href="<?php echo base_url('Home/rekap'); ?>" class="btn btn-primary btn-sm" role="button" target="_blank">Rekap</a>
                        <br><br>
