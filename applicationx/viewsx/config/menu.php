...
echo $nama; ?></p>
      ...
      <a href="<?php echo base_url('Utama/keluar'); ?>">
        <i class="fa fa-envelope"></i> <span>Surat Keluar</span>
            ...
            <li>
                <a href="<?php echo base_url('Home/indikator_program'); ?>">
                    <i class="fa fa-edit"></i> <span>Indikator Program</span>

                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Home/indikator_kegiatan'); ?>">
                    <i class="fa fa-edit"></i> <span>Indikator Kegiatan</span>

                </a>
            </li>

            <li>
                <a href="<?php echo base_url('Home/indikator'); ?>">
                    <i class="fa fa-edit"></i> <span>Indikator Kinerja</span>
            ...
            <li>
                <a href="<?php echo base_url('Home/realisasi'); ?>">
                    <i class="fa fa-edit"></i> <span>Realisasi Anggaran</span>
