            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <a href="<?php echo base_url('Home/rekap'); ?>" class="btn btn-primary btn-sm" role="button" target="_blank">Rekap</a> -->
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="<?php echo base_url('Home/riwayat_keluarga/' . $row->nort . '/' . $row->iddasawisma) ?>" class="btn btn-danger btn-sm">Lihat</a>
                                        </td>
                                    </tr>
