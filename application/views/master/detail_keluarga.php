                    ...
                    <div class="panel-body">
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" required="" class="form-control" name="dasawisma" value="<?php echo $this->session->userdata('nama_dasawisma'); ?>" <?php if ($this->session->userdata('id_role') != 1 && $this->session->userdata('id_role') != 2) { ?>readonly <?php } ?>>
                            ...
                            <div class="form-group">
                                <label>RT</label>
                                <input type="text" required="" class="form-control" name="rt" value="<?php echo $this->session->userdata('rt'); ?>">
                            </div>
                            <div class="form-group">
                                <label>RW</label>
                                <input type="text" required="" class="form-control" name="rw" value="<?php echo $this->session->userdata('rw'); ?>" <?php if ($this->session->userdata('id_role') == 4) { ?>readonly <?php } ?>>
                            </div>
                            <a href="" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-editwil" role="button">Edit Wilayah</a>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required="" class="form-control" name="prop" value="Jawa Timur" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <!-- Modal edit wilayah -->
                                        <div class="modal fade" id="modal-editwil">
                                            <div class="modal-dialog modal-lg">
                                                <form action="<?php echo base_url('Home/update_wilayah'); ?>" method="post">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span></button>
                                                            <h4 class="modal-title">Edit Wilayah KK</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-6 col-sm-6">
                                                                    <!-- <div class="form-group">
                                                                        <Label>Nama Dasawisma</Label>
                                                                        <input type="text" required="" class="form-control" name="dasawisma" value="<?php echo $this->session->userdata('nama_dasawisma'); ?>">
                                                                        <input type="hidden" required="" class="form-control" name="iddasawisma" value="<?php echo $this->session->userdata('iddasawisma'); ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <Label>Desa/Kelurahan</Label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <Label>RW</Label>
                                                                        <input type="text" required="" class="form-control" name="rw" value="<?php echo $this->session->userdata('rw'); ?>">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>NIK</label>
                                                                        <input type="number" required="" class="form-control" placeholder="Nomor Induk Keluarga" name="nik" value="<?php echo $row->nik; ?>" minlength="16" maxlength="16">
                                                                    </div>
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" name="susu" <?php if ($row->jk == 1) { ?> disabled <?php } ?>>
                                                                            <?php if ($row->idsusu == 1) {
                                                                            ?>
                                                                                <option value="1" selected>Ya</option>
                                                                                <option value="2">Tidak</option>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" name="lansia">
                                                                            <?php if ($row->idlansia == 1) {
                                                                            ?>
                                                                                <option value="1" selected>Ya</option>
                                                                                <option value="2">Tidak</option>
                                                                            <?php
                                                                            } elseif ($row->idlansia == 2) {
                                                                            ?>
                                                                                <option value="1">Ya</option>
                                                                                <option value="2" selected>Tidak</option>
                                                                            <?php
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>NIK</label>
                                                    <input type="text" required="" class="form-control" placeholder="Nomor Induk Keluarga" name="nik" onkeyup="getNik()" maxlength="16" minlength="16">
                                                </div>
                                                <div class="form-group">
                                                    <label>NAMA LENGKAP</label>
                                                ...
                                                <div class="form-group">
                                                    <label>TANGGAL LAHIR</label>
                                                    <input type="date" required="" class="form-control" id="tahun_lahir" placeholder="Tanggal Lahir" name="tanggal_lahir" max="9999-12-31">
                                                </div>
                                                <div class="form-group">
                                                    <label>Hubungan Keluarga</label>
                                                    <select class="form-control" name="hub_dgn_kk" id="hub_dgn_kk">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sumber_air1">
                                        ...
                                        ?>
                                            <option value="1">PDAM</option>
                                            <option value="2">Sumur</option>
                                            <option value="3" selected>Sungai</option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" value="<?php echo $sumber_air_lain ?>" name="sumber_air2">
                                </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="form-group">
                                    <!-- <label>Lainnya</label> -->
                                    <input type="hidden" class="form-control" value="<?php echo $aktifitas_lain; ?>" name="up2k2">
                                </div>
                                <div class="form-group">
