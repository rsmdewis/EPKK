  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      ...
      <div class="pull-left info">
        ...
        <p><b><span id="jam" style="color:#ffff"></span></b></p>
      </div>
    </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      ?>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('Home/dasawisma'); ?>"><i class="fa fa-file-o"></i>Manajemen User</a></li>
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-file"></i> <span>Data Riwayat</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          <li><a href="<?php echo base_url('Home/list_riwayat'); ?>"><i class="fa fa-file-o"></i>Riwayat</a></li>
